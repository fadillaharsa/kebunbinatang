...
@section('content')
    <div class="d-flex justify-content-between align-items-center text-center">
        <a href="{{ route("lihatfasilitas",$satwa->facility->id) }}" class="btn btn-success text-white rounded-circle">
...
<script>
    function openDirectionPage(lat, lng, id) {
        window.open(`/fasilitas/${id}/petunjuk?fromLat=${objAsalCoord.lat}&fromLng=${objAsalCoord.lng}&toLat=${lat}&toLng=${lng}`, "_self");
    }
</script>
@endpush